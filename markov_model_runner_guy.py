...
def calc_statistics(confusion_cols, pred, lbl, pos_vals=None, neg_vals=None, i=None, verbose=False):
    global total_acc
    ...
    confusion = confusion_matrix(lbl, pred, labels=confusion_cols)
    total_acc.append(overall_accuracy) # todo del
...
def run_and_stat(emission_df, transition_df, start_state, generator, pos_vals=None, neg_vals=None, max_amnt=None):
    ...
    for i, (seq, lbl) in enumerate(generator):
        ...
        for l in pos_vals:
            pred_arr[pred_arr == l] = 'M'
        for l in neg_vals:
            pred_arr[pred_arr == l] = 'I'
        pred_arr[pred_arr == 'g'] = 'E'
        acc, tpr, tnr, confusion = calc_statistics(['M', 'I', 'E'], pred_arr, lbl_arr,
    ...
    plot_confusion_matrix_from_data(lbl_arr, pred_arr, ['M', 'I', 'E'], True,
...
if __name__ == '__main__':
    ...
    gene_gen = getSeq('./hg19.genes.NR.chr19.exonCount2_29.bed', './hg19.2bit')
    run_and_stat(emission_df, transition_df, 'F', gene_gen,  ['F', 'M', 'L'], ['I'], max_amnt=100)